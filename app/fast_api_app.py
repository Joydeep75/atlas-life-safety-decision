...
app.title = "atlas-life-safety-decision"
app.description = "API for interacting with the Agent atlas-life-safety-decision"
...
def collect_feedback(feedback: Feedback) -> dict[str, str]:
    ...
    if gcp_logging_available:
        try:
            ...
            import logging
            logging.getLogger("fast_api_app").info(f"Feedback: {feedback.model_dump()}")
    else:
